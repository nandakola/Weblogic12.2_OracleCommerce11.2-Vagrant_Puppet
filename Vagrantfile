...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define "admin" , primary: true do |admin|
    ...
    admin.vm.synced_folder "D:/Clients/mFleet/software", "/software", :mount_options => ["dmode=777","fmode=777"]
...
#                                  '--parser future',
  ...
  config.vm.define "store" do |node1|
    ...
    node1.vm.synced_folder "D:/Clients/mFleet/software", "/software"
...
#                                  '--parser future',
  ...
  config.vm.define "bcc" do |node2|
    ...
    node2.vm.synced_folder "D:/Clients/mFleet/software", "/software"
